...
if( !function_exists('cminds_cmtoc_settings_table_of_content_tab_content_after') )
{

    function cminds_cmtoc_settings_table_of_content_tab_content_after($content)
    {
        ob_start();
        ?>
        <div class="block">
            <h3>Table of Contents - Styling</h3>
            <table class="floated-form-table form-table">
                <tr valign="top">
                    <th scope="row">Level 0:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel0Size" value="<?php echo esc_attr(get_option('cmtoc_table_of_contentsLevel0Size')); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content title (if set)</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 1:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel1Size" value="<?php echo esc_attr(get_option('cmtoc_table_of_contentsLevel1Size')); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 2:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel2Size" value="<?php echo esc_attr(get_option('cmtoc_table_of_contentsLevel2Size')); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 3:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel3Size" value="<?php echo esc_attr(get_option('cmtoc_table_of_contentsLevel3Size')); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 4:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel4Size" value="<?php echo esc_attr(get_option('cmtoc_table_of_contentsLevel4Size')); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 5:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel5Size" value="<?php echo esc_attr(get_option('cmtoc_table_of_contentsLevel5Size')); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
            </table>
        </div>
...
if( !function_exists('cmtoc_cminds_dropdown') )
{
     ...
     */
    function cmtoc_cminds_dropdown($args = '')
    {
        $defaults = array(
            'depth'                 => 0, 'child_of'              => 0,
            'selected'              => 0, 'echo'                  => 1,
            ...
            'option_none_value'     => '', 'add_posts'             => 1, 'post_type'             => 'page'
        );
        ...
        if( !empty($pages) )
        {
            ...
            if( $r['add_posts'] )
            {
                ...
                if( !empty($posts) )
                {
                    ...
                    $output .= cminds_walk_post_dropdown_tree($posts, $r['depth'], $r);
                    $output .= '</optgroup>';
                }
            }
            $output .= "</select>\n";
...
if( !class_exists('Cminds_Walker_PostDropdown') )
{

    class Cminds_Walker_PostDropdown extends Walker
    {
        /**
        ...
        function start_el(&$output, $object, $depth = 0, $args = array(), $current_object_id = 0)
        {
            ...
            if( $object->ID == $args['selected'] ) $output .= ' selected="selected"';
            $output .= '>';
...
if( !function_exists('cminds_walk_post_dropdown_tree') )
{

    function cminds_walk_post_dropdown_tree()
    {
        $args = func_get_args();
        if( empty($args[2]['walker']) )
        { // the user's options are the third parameter
            $walker = new Cminds_Walker_PostDropdown;
        }
        else
        {
